...
public class SimpleScriptContext implements ScriptContext {
    ...
    public Object getAttribute(String var1) {
        this.checkName(var1);
        return this.engineScope.containsKey(var1) ? this.getAttribute(var1, 100) : (this.globalScope != null && this.globalScope.containsKey(var1) ? this.getAttribute(var1, 200) : null);
    }
    ...
    public int getAttributesScope(String var1) {
        this.checkName(var1);
        return this.engineScope.containsKey(var1) ? 100 : (this.globalScope != null && this.globalScope.containsKey(var1) ? 200 : -1);
    }
